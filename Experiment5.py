...
# each next row in child is selected from parents starting from row 0-9, starting parent is randomly chosen
def crossover_ind(parent, parent2):
    r1 = get_rows(parent)
    r2 = get_rows(parent2)
    numbers = [i for i in range(9)]
    f = numbers[::2]  # list of even rows
    s = numbers[1::2]  # list of odd rows
    first = choice([r1, r2])
...
mutation_rates_grid1 = [0.02, 0.04, 0.04, 0.04]

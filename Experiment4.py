...
# CHILD CONSISTS OF 2 HAVES: FIRST HALS IS HALF OF ALL FIRST PARENT’S ROWS
# AND SECOND HALF IS HALF OF ALL SECOND PARENT’S ROWS

def crossover_ind(parent, parent2):
    r1 = get_rows(parent)
    r2 = get_rows(parent2)
    child = r1[:len(r1) // 2] + r2[len(r2) // 2:]
